...
![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,16,20,24&height=200&section=header&text=Hey,%20I'm%20Gina%20✦&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=UI/UX%20Designer%20%7C%20Pixel%20perfectionist%20%7C%20occasional%20coder&descAlignY=58&descSize=18)

</div>

<div align="center">

`designing things people actually enjoy using` ✨ `currently obsessed with booking flows`
...
right now i'm deep in **Tiketux**, untangling booking funnels and shipping features that don't make people rage-quit a bus ticket app. when i'm not in Figma i'm probably soldering something i shouldn't be, or arguing with Python about why it won't read my struk photo.
